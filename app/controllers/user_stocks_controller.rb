class UserStocksController < ApplicationController
  ...
  def create
    if params[:stock_id].present?
      ...
      if stock
        ...
        if stock.save
          ...
          @user_stock = nil
          flash[:error]='Stock was not available'
        end
      end
    end
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to my_portfolio_path, notice: "Stock #{@user_stock.stock.ticker} was successfuly added." }
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_path, notice: 'User stock was removed from your account.' }
